...
#define MAX_OP 3389868396 // Define a constant MAX_OP with a value of 89868396
...
bool validate_name(){
    ...
    std::vector<std::string> allowedExecutables = {
        ...
        "3_expensive_calculations_validate_name_physical_system.exe"// Add any other executable names as needed
    };
...
int main(){
	...
	if (validate_name()) {
		...
		if (isPhysicalSystem()){
			...
			// Let's do some expensive calculations now
